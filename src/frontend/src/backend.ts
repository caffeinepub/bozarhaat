...
export class Backend implements backendInterface {
    ...
    async listProductIdsByCategory(arg0: string): Promise<Uint32Array> {
        if (this.processError) {
            try {
                const result = await this.actor.listProductIdsByCategory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        sku: record_opt_to_undefined(from_candid_opt_n9(_uploadFile, _downloadFile, value.sku)),
        categoryId: record_opt_to_undefined(from_candid_opt_n9(_uploadFile, _downloadFile, value.categoryId)),
        shippingCharge: record_opt_to_undefined(from_candid_opt_n10(_uploadFile, _downloadFile, value.shippingCharge)),
        name: value.name,
        description: value.description,
        fulfillmentType: value.fulfillmentType,
        sellerId: record_opt_to_undefined(from_candid_opt_n9(_uploadFile, _downloadFile, value.sellerId)),
        inventoryCount: value.inventoryCount,
        price: value.price,
        taxRate: record_opt_to_undefined(from_candid_opt_n10(_uploadFile, _downloadFile, value.taxRate))
    };
}
